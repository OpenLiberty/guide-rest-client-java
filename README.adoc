...
Which responds with the [hotspot=1-32]`artists.json`
...
For your test classes to have access to JSON-B, the following dependency has been added in your [hotspot=89-94 file=1]`pom.xml`
