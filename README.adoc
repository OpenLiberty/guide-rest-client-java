...
The [hotspot=JSON-B-provider file=1]`jsonb-1.0 feature` has been added as a dependency in your [hotspot file=1]`pom.xml`
...
For your test classes to have access to JSON-B, the [hotspot=Yasson file=1]`yasson` dependency has been added in your `pom.xml`.
