...
for you and is accessible at the following link when the server is running http://localhost:9080/artists[window="_blank"]
...
When the server is running, you can find your service at http://localhost:9080/artists[window="_blank"]
