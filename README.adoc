...
The [hotspot=7-34 file=0]`Artist` object has two instance members [hotspot=23 file=0]`name` and [hotspot=24 file=0]`albums`, 
...
Maven finds and executes all tests under `it/` and each test method must be marked with the [hotspot=43 hotspot=62 hotspot=77 hotspot=88]`@Test` annotation.
