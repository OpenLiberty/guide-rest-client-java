...
for you and is accessible at the following link when the server is running http://localhost:9080/artists
...
The [hotspot=78-86]`testJsonBAlbumCountForUnknownArtist` test case is similar to [hotspot=63-75]`testJsonBAlbumCount`
